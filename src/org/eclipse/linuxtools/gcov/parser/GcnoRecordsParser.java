...
public class GcnoRecordsParser {
    ...
    private final List<GcnoFunction> fnctns  = new ArrayList<GcnoFunction>();
    private final List<SourceFile> currentAllSrcs;
    private final Map<String, SourceFile> sourceMap;

    public GcnoRecordsParser(Map<String, SourceFile> sourceMap, List<SourceFile> AllSrcs){
        this.sourceMap = sourceMap;
        this.currentAllSrcs = AllSrcs;
    }

    private SourceFile findOrAdd (String fileName, List<SourceFile> srcs)
    {
    ...
    /* Getters */
    public List<GcnoFunction> getFnctns() {
        return fnctns;
    }

    public List<SourceFile> getcurrentAllSrcs() {
